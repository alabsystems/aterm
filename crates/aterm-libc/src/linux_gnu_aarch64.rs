...
//! `libc` for `aarch64-unknown-linux-gnu`.
//!
...
pub const HWCAP_AES: c_ulong = 8;
pub const HWCAP_DIT: c_ulong = 16777216;
pub const HWCAP_PMULL: c_ulong = 16;
pub const HWCAP_SHA2: c_ulong = 64;
pub const HWCAP_SHA3: c_ulong = 131072;
pub const HWCAP_SHA512: c_ulong = 2097152;
pub const HWCAP_SM3: c_ulong = 262144;
pub const HWCAP_SM4: c_ulong = 524288;
...
pub const O_TMPFILE: c_int = 4210688;
...
/// const-eval probe compiled for aarch64-unknown-linux-gnu and are asserted byte-exact
/// against the oracle.
...
pub const PTHREAD_MUTEX_INITIALIZER: pthread_mutex_t = unsafe {
    ::core::mem::transmute::<[u8; 48], pthread_mutex_t>([
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00,
