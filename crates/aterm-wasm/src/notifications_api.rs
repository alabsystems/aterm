...
//! [`AtermTerminal`]: an authorization passthrough plus a poll drain,
...
//! ([`wire_notification_queue`]) that [`AtermTerminal::take_notifications`]
//! drains.
//!
//! The engine's authorization gate stays authoritative and fail-closed:
//! until the host calls [`AtermTerminal::authorize_notifications`] with
